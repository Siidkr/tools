          ...
          >
             ...
             <div className={`flex flex-col h-full w-full transition-opacity duration-700 delay-500 ${stage === 'reading' ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className="font-hand text-gray-700 text-lg mt-4 space-y-4">
                    ...
                    <p>
                         being with you tuh rasanya simple tapi meaningful. Kita nggak selalu perfect, but we always try, and that’s what matters. 
                         Kamu bukan cuma pacar, tapi juga best partner, tempat cerita, tempat pulang, dan orang yang selalu aku pilih.
                    </p>
